...
RegisterServerEvent('don-jewellery:server:ToggleDoorlocks', function(store, locked, allStores)
  ...
  if not allStores then
    ...
    elseif Config.DoorLock == 'ox' then
      local door = exports['ox_doorlock']:getDoorFromName('jewellery_stores ' ..Config.Stores[store]['Doors'].main) or exports['ox_doorlock']:getDoorFromName(Config.DoorLock.Extraname .. ..Config.Stores[store]['Doors'].main)
    ...
    for i = 1, #Config.Stores do
      ...
      elseif Config.DoorLock == 'ox' then
        local main = exports['ox_doorlock']:getDoorFromName('jewellery_stores ' ..Config.Stores[i]['Doors'].main) or exports['ox_doorlock']:getDoorFromName(Config.DoorLock.Extraname .. ..Config.Stores[i]['Doors'].main)
        local sec = exports['ox_doorlock']:getDoorFromName('jewellery_stores ' ..Config.Stores[i]['Doors'].sec) or exports['ox_doorlock']:getDoorFromName(Config.DoorLock.Extraname .. ..Config.Stores[i]['Doors'].sec)
